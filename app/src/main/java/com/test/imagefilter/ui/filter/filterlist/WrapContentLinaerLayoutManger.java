...
public class WrapContentLinaerLayoutManger extends LinearLayoutManager {

    private int[] mMeasuredDimension = new int[2];

    public WrapContentLinaerLayoutManger(Context context, int orientation, boolean reverseLayout) {
